<template>
  <div>
    <div class="main">
      <header class="header">
      <section ref="intro_box" class="intro-box">
      <div ref="intro_container" class="intro-container">
...
.intro-box{
background: linear-gradient(to right bottom, rgba(87, 167, 41, 1), rgba(100, 172, 82, 0.5));
width:25vw;
height: 60vh;
position: relative;
left: -2rem;
